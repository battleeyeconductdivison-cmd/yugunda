...
if LPH_OBFUSCATED == nil then
    ...
    LRM_ScriptName = "yugunda"
    LRM_TotalExecutions = 0
    LRM_SecondsLeft = math.huge
    LRM_UserNote = "ygggggggggggggg ";
end;
...
local Config = {
    ["TheBronx"] = {
        ...
        ["TeleportationList"] = {
            ["Capital One Bank "] = CFrame.new(-226.67, 283.81, -1207.44);
            ["Ice Box "] = CFrame.new(-198.8927001953125, 283.8486633300781, -1170.4500732421875);
            ["Chicken Place"] = CFrame.new(-747.63, 253.76, -785.84);
            ["Hotel "] = CFrame.new(-1012, 266, -933);
            ["Drip Store 👓"] = CFrame.new(67462.6953125, 10489.0322265625, 546.6762084960938);
            ["Gun Shop "] = CFrame.new(92955.53, 122098.50, 17283.28);
            ["Car Dealer "] = CFrame.new(-400.27, 253.41, -1239.68);
            ...
            ["Hospital"] = CFrame.new(-1590.56, 254.27, 16.82); -- nah
            ["Rooftop "] = CFrame.new(-395.98, 334.31, -554.99);
        ...
        if Game_Name == "The Bronx" and RequireSupport then                                                
            ...
            local ModWeapon = LPH_JIT_MAX(function(Weapon)
                ...
                if Config.TheBronx._Modifications.InfiniteClips then
                    debug.setupvalue(getsenv(Weapon:FindFirstChild("GunScript_Local")).Reload, 3, 15000)
...
local window = library:window({name = "yugunda", suffix = "", gameInfo = string.format("bronx.lol : %s", Game_Name:lower())})
